...
<header>
    ...
    <div class="wrap-header-mobile">
        ...
        <div class="logo-mobile">
            <a href="index.html"><img src="/customer/images/icons/logo-01.png" alt="IMG-LOGO"></a>
        </div>
    ...
    <div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
        <div class="container-search-header">
            <button class="flex-c-m btn-hide-modal-search trans-04 js-hide-modal-search">
                <img src="/customer/images/icons/icon-close2.png" alt="CLOSE">
            </button>
        ...
        <div class="row">
            <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                ...
                <div class="block1 wrap-pic-w">
                    <img src="/customer/images/banner-01.jpg" alt="IMG-BANNER">
            ...
            <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                <!-- Block1 -->
                <div class="block1 wrap-pic-w">
                    <img src="/customer/images/banner-02.jpg" alt="IMG-BANNER">
            ...
            <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                <!-- Block1 -->
                <div class="block1 wrap-pic-w">
                    <img src="/customer/images/banner-03.jpg" alt="IMG-BANNER">
    ...
    <div class="container">
        ...
        <div class="row isotope-grid">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item shoes">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="/customer/images/product-09.jpg" alt="IMG-PRODUCT">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="/customer/images/product-10.jpg" alt="IMG-PRODUCT">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="/customer/images/product-11.jpg" alt="IMG-PRODUCT">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="/customer/images/product-12.jpg" alt="IMG-PRODUCT">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="/customer/images/product-13.jpg" alt="IMG-PRODUCT">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="/customer/images/product-14.jpg" alt="IMG-PRODUCT">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item watches">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="/customer/images/product-15.jpg" alt="IMG-PRODUCT">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="/customer/images/product-16.jpg" alt="IMG-PRODUCT">
    ...
    <div class="container">
        <div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
            <button class="how-pos3 hov3 trans-04 js-hide-modal1">
                <img src="/customer/images/icons/icon-close.png" alt="CLOSE">
            </button>
                            ...
                            <div class="slick3 gallery-lb">
                                <div class="item-slick3" data-thumb="/customer/images/product-detail-01.jpg">
                                    <div class="wrap-pic-w pos-relative">
                                        ...
                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="/customer/images/product-detail-01.jpg">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                </div>

                                <div class="item-slick3" data-thumb="/customer/images/product-detail-02.jpg">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="/customer/images/product-detail-02.jpg" alt="IMG-PRODUCT">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="/customer/images/product-detail-02.jpg">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                </div>

                                <div class="item-slick3" data-thumb="/customer/images/product-detail-03.jpg">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="/customer/images/product-detail-03.jpg" alt="IMG-PRODUCT">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="/customer/images/product-detail-03.jpg">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                ...
                                <div class="size-204 respon6-next">
                                    <div class="rs1-select2 bor8 bg0">
                                        <select class="/customer/js-select2" name="time">
