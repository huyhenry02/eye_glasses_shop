    ...
    public function run(): void
    {
        ...
        foreach ($csvData as $index => $row) {
            ...
            $products[] = [
                ...
                'image' => '/customer/img/product/product.avif',
                'image_detail_1' => '/customer/img/product/product-detail-1.avif',
                'image_detail_2' => '/customer/img/product/product-detail-2.avif',
                'image_detail_3' => '/customer/img/product/product-detail-3.avif',
